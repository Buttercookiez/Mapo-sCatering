...
const BookingSidebar = ({ details, theme, handleUpdateStatus }) => {
  return (
    ...
    >
      ...
      >
        <div
          className={` justify-center text-[#C9A25D] text-xl font-serif italic mb-3 border ${theme.border} bg-transparent`}
        >
          {/* Avatar placeholder or content goes here */}
        </div>
      ...
      <div className="space-y-6">
        ...
        {/* Action / Status Box */}
        {/* Only render if we have a specific status to show actions for */}
